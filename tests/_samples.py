...
SAMPLES: dict[str, tuple[DateTimeObj, dict[BindType, str]]] = {
    ...
    "в час дня": (
        ...
        {
            BindType.FUTURE: "2023-12-31 13:00",
        }
    ),  # час дня уже прошел - это на завтра
    "в 2 часа дня": (
        DateTimeObj(hour=2, spec=TimeSpecType.PM),
        {
            BindType.FUTURE: "2023-12-31 14:00",
        }
    ),  # уже два часа дня - на завтра
    "в два часа ночи": (
        DateTimeObj(hour=2, spec=TimeSpecType.AM),
        {
            BindType.FUTURE: "2023-12-31 02:00",
        }
    ),  # два часа ночи уже прошли
    "в 8 вечера": (
        DateTimeObj(hour=8, spec=TimeSpecType.PM),
        {
            BindType.FUTURE: "2023-12-30 20:00",
        }
    ),  # 8 вечера ещё не было - сегодня
    "8 вечера": (
        DateTimeObj(hour=8, spec=TimeSpecType.PM),
        {
            BindType.FUTURE: "2023-12-30 20:00",
    ...
    "в шесть утра": (
        ...
        {
            BindType.FUTURE: "2023-12-31 06:00",
        }
    ),
    "в шесть часов утра": (
        DateTimeObj(hour=6, spec=TimeSpecType.AM),
    ...
    ),  # 14 часов уже было - завтра
    "в 14 часов 30 минут": (
        DateTimeObj(hour=14, minute=30, spec=None),
        {
            BindType.FUTURE: "2023-12-30 14:30",
        }
    ),
    "в 20 минут": (
        DateTimeObj(minute=20, spec=None),
        {
            BindType.FUTURE: "2023-12-30 14:20",
        }
    ),
    "в 20 минут шестого": (
    ...
    "в без двадцати час": (
        ...
        {
            BindType.FUTURE: "2023-12-31 12:40",
        }
    ),
    "в без двадцати пяти час": (
        DateTimeObj(hour=12, minute=35, spec=None),
        {
            BindType.FUTURE: "2023-12-31 12:35",
        }
    ),
    ...
    "в без двадцати пять часов": (
        ...
        {
            BindType.FUTURE: "2023-12-30 16:40",
        }
    ),
    "в 14:30": (
